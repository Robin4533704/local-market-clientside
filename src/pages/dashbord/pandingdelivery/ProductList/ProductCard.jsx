...
const ProductCard = () => {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      Swal.fire({
        ...
        html: `<p>Order ID: <strong>${res.data.orderId}</strong></p>`,
        confirmButtonText: "OK",
      });

      // ✅ Notification automatically created by backend via /orders
      // আর এখানে আলাদা POST /notifications দরকার নেই
  ...
  return (
    <div className="pt-26 px-4 md:px-20 bg-[#f5f0e1] min-h-screen font-sans">
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-center border-t border-gray-300 pt-6 gap-4">
        <div>
