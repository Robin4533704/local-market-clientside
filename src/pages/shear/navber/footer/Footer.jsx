...
const Footer = () => {
  ...
  return (
    <footer className="bg-lime-600 text-gray-400 py-12">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
        
        {/* LOGO */}
        <div>
          <Profileslogo />
          <p className="text-sm italic ml-18 -mt-2 text-yellow-400">Farming since 1996</p>
        </div>
        ...
        <div className="text-white">
          ...
          <NavLink to="/coverage" className="inline-flex items-center text-yellow-300 hover:text-yellow-400 mt-2">
            Get Directions
          </NavLink>
