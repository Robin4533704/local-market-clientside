...
const About = () => {
  return (
   <section className="bg-gray-100 pt-24 pb-12"> {/* pt-24 navbar height অনুযায়ী adjust করো */}
  <div className="max-w-5xl mx-auto px-6 text-center">
    ...
    <div className="flex justify-center gap-4">
      <Link
        to='/OrganicEssentials'
        className="bg-yellow-400 text-white font-semibold px-4 py-2 rounded-full shadow hover:bg-yellow-500 transition duration-300"
      >
        Learn More
      </Link>
      <Link
        to='/contactus'
        className="bg-green-400 text-white font-semibold px-4 py-2 rounded-full shadow hover:bg-yellow-500 transition duration-300"
      >
        Contact Us
      </Link>
    </div>
