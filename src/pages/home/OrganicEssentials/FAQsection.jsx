   ...
   <div className='bg-red-100 p-8'>
     <div className=" max-w-3xl mx-auto">
      ...
      <div className="space-y-4">
        {faqs.map((faq, index) => (
          <div key={index} className="border rounded-lg bg-red-100 shadow-md">
            <button
            ...
            >
              ...
              {openIndex === index ? (
                <svg
                  className="w-5 h-5 bg-amber-300 rounded-xl  transform rotate-180 transition-transform duration-200"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <svg
                  className="w-5 h-5 bg-amber-300 rounded-xl transition-transform duration-200"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            {openIndex === index && (
              <div className="px-4 pb-4 bg-blue-100 text-gray-700">{faq.answer}</div>
            )}
          </div>
        ))}
      </div>
